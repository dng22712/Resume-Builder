...
$(function () {
  var $selectedAuthentication = $('#selected-registration_authentication')
  ...
  $('form.api-interaction').submit(function (event) {
    ...
    // Setup registration_authentication options.
    if (window.auth && window.auth.type === 'token') {
      // Header registration_authentication
      ...
      // Basic registration_authentication
      ...
      // Session registration_authentication
  ...
  $('form.registration_authentication-token-form').submit(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.registration_authentication-basic-form').submit(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.registration_authentication-session-form').submit(function (event) {
    event.preventDefault()
    window.auth = {
      'type': 'session'
    }
